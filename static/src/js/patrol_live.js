...
require(["jquery","layui","path","ckplayer","boot-dropdown"],function($,layui,path,ckplayer){
 ...
 $(".video").each(function(index, el) {
               var file_key = $(this).attr("data-hls");
                ...
                var html =  '<video id="id_'+index+'"  class="video-js vjs-big-play-centered vjs-4-3" controls preload="auto" poster=""><source src="'+ file_key +'" type="application/x-mpegURL"></video>'
                $(this).html(html);          
   });
